...
const Page = () => {
  ...
  const handleConversion = () => {
    setMicrograms(grams ? grams * 1000000 : '');
    setShowResult(true);
  };
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center bg-white min-h-screen h-80 mx-2 rounded-lg mt-10 p-4">
        <h1 className="text-2xl font-bold mb-4">Gram to Microgram Converter</h1>
        ...
        {showResult && (
          <p className="text-lg mt-2">Micrograms: <span className="font-semibold">{micrograms}</span></p>
        )}
      </div>
      <Footer />
    </div>
