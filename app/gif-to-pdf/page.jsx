    ...
    const handleConvert = async () => {
        ...
        try {
            const response = await axios.post(
                'https://v2.convertapi.com/convert/gif/to/pdf?secret=x7fFowh7f4l2j2LL',
                formData,
                {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen  bg-gray-100 p-4">
            <div className="bg-white shadow-md rounded-lg p-6 h-auto  w-full">
                <h1 className="text-xl font-semibold mb-4 text-center">GIF to PDF Converter</h1>
                <input type="file" accept=".gif" onChange={handleFileChange} className="w-full p-2 border rounded mb-4" />
                <button
...
export default GifToPdfConverter;
